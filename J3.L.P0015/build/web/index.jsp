                        ...
                        <div class="px-3">
                            <div class="split-bottom flex pt-5 pb-5">
                                ...
                                <div class="content">
                                    ...
                                    <p class="font-sans mt-1">${articleIntroduction.description}</p>
                                </div>
                            </div>
                            <div class="split-bottom pt-6 flex pb-5">
                                <div class="mr-3">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="font-sans mt-1">${articleLeft.description}</p>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="font-sans mt-1">${articleRight.description}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="split-bottom pb-5">
                                ...
                                <p>${contactPhone.detail}: ${contactPhone.value}</p>
                            </div>
                            <div class="mt-6">
                                <p>Kind regards</p>
                                <p class="text-5">Visit my cafe</p>
